...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Input
    {
        ...
        public static Valve.VR.SteamVR_Input_ActionSet_selection selection;
        ...
        public static void Dynamic_InitializeActionSets()
        {
            ...
            SteamVR_Input.selection.Initialize();
        }
        ...
        public static void Dynamic_InitializeInstanceActionSets()
        {
            ...
            Valve.VR.SteamVR_Input.selection = ((SteamVR_Input_ActionSet_selection)(SteamVR_Input_References.GetActionSet("selection")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[]
            {
                    Valve.VR.SteamVR_Input._default,
                    Valve.VR.SteamVR_Input.platformer,
                    Valve.VR.SteamVR_Input.buggy,
                    Valve.VR.SteamVR_Input.selection};
        }
    }
}
